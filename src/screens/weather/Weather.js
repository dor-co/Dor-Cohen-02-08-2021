...
function Weather() {
  ...
  console.log('selectCityReducer',selectCityRed.data.target.value)
  ...
  const getForecast = async (key) => {
    ...
    // const index = data.findIndex(x => x.LocalizedName === value);
    ...
    // setForecast(res);
    //console.log(res.data.DailyForecasts.length)
